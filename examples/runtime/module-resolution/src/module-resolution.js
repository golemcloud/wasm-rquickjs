...
export const testEsmDataUrlImportAttributes = async () => {
    try {
        ...
        await import('data:text/javascript,' + encodeURIComponent([
            ...
            'const cachedTypeErrorUrl = "data:text/javascript,export default 1#cached-type-error";',
            'await expectReject("initial JS URL type mismatch should reject as incompatible", import(cachedTypeErrorUrl, { with: { type: "json" } }), { code: "ERR_IMPORT_ATTRIBUTE_TYPE_INCOMPATIBLE" });',
            'await expectReject("same JS URL with unsupported extra key should reuse cached type mismatch", import(cachedTypeErrorUrl, { with: { type: "json", other: "unsupported" } }), { code: "ERR_IMPORT_ATTRIBUTE_TYPE_INCOMPATIBLE" });',
        ...
        fs.writeFileSync(
            ...
            [
                ...
                '    if (result.format !== "builtin") throw new Error("nextResolve did not report bare builtin format: " + result.format);',
                '    const nodeResult = await next("node:fs", context);',
                '    if (nodeResult.url !== "node:fs") throw new Error("nextResolve changed node: builtin URL: " + nodeResult.url);',
                '    if (nodeResult.format !== undefined) throw new Error("nextResolve reported node: builtin format: " + nodeResult.format);',
...
export const testLoaderCommonjsSourceNamedExports = async () => {
    ...
    try {
        ...
        await import('data:text/javascript,' + encodeURIComponent([
            ...
            '  }',
            '  if (specifier === "virtual:loader-cjs-member-reexport") {',
            '    return { shortCircuit: true, url: "file:///loader-cjs-source-app/member-reexport.cjs", format: "commonjs" };',
            '  }',
            '  if (specifier === "virtual:loader-cjs-member-define-property") {',
            '    return { shortCircuit: true, url: "file:///loader-cjs-source-app/member-define-property.cjs", format: "commonjs" };',
            '  }',
            '  if (specifier === "virtual:loader-cjs-member-exports") {',
            '    return { shortCircuit: true, url: "file:///loader-cjs-source-app/member-exports.cjs", format: "commonjs" };',
            '  }',
            '  if (specifier === "virtual:loader-cjs-member-module") {',
            '    return { shortCircuit: true, url: "file:///loader-cjs-source-app/member-module.cjs", format: "commonjs" };',
            '  }',
            ...
            '  }',
            '  if (specifier === "virtual:loader-cjs-keys-asi-unary") {',
            '    return { shortCircuit: true, url: "file:///loader-cjs-source-app/keys-asi-unary.cjs", format: "commonjs" };',
            '  }',
            ...
            '  }',
            '  if (specifier === "virtual:loader-cjs-keys-rhs-member") {',
            '    return { shortCircuit: true, url: "file:///loader-cjs-source-app/keys-rhs-member.cjs", format: "commonjs" };',
            '  }',
            ...
            '  }',
            '  if (specifier === "virtual:loader-cjs-retry") {',
            '    return { shortCircuit: true, url: "virtual:loader-cjs-retry", format: "commonjs" };',
            '  }',
            '  if (specifier === "virtual:loader-cjs-cycle-a" || specifier === "virtual:loader-cjs-cycle-b") {',
            '    return { shortCircuit: true, url: specifier, format: "commonjs" };',
            '  }',
            '  if (specifier === "alias-from-next") {',
            '    const result = next("./aliased-dep.cjs", { parentURL: "file:///loader-cjs-source-app/entry.cjs" });',
            '    if (Object.prototype.hasOwnProperty.call(result, "source")) throw new Error("relative nextResolve eagerly read CJS source");',
            '    return result;',
            '  }',
            '  if (specifier === "alias-file-url-from-next") {',
            '    const result = next("file:///loader-cjs-source-app/aliased-dep.cjs", context);',
            ...
            '    return { shortCircuit: true, url: "virtual:missing-file-url-fallback", format: "commonjs" };',
            '  }',
            '  if (specifier === "alias-imports-from-next") {',
            '    const result = next("#sync-loader-import-condition", { parentURL: "file:///loader-cjs-source-app/entry.cjs", conditions: ["customSyncLoader"] });',
            '    if (Object.prototype.hasOwnProperty.call(result, "source")) throw new Error("imports nextResolve eagerly read CJS source");',
            '    return result;',
            '  }',
            '  if (specifier === "alias-package-from-next") {',
            '    const result = next("sync-loader-pkg", { parentURL: "file:///loader-cjs-source-app/entry.cjs", conditions: ["customSyncLoader"] });',
            '    if (Object.prototype.hasOwnProperty.call(result, "source")) throw new Error("package nextResolve eagerly read CJS source");',
            '    return result;',
            '  }',
            ...
            '  }',
            '  if (specifier === "alias-fs-next-bare") {',
            '    const result = next("fs", context);',
            '    if (result.url !== "node:fs") throw new Error("CJS nextResolve did not preserve bare builtin: " + result.url);',
            '    if (result.format !== "builtin") throw new Error("CJS nextResolve did not report bare builtin format: " + result.format);',
            '    return result;',
            '  }',
            '  if (specifier === "alias-fs-next-node") {',
            '    const result = next("node:fs", context);',
            '    if (result.url !== "node:fs") throw new Error("CJS nextResolve changed node: builtin URL: " + result.url);',
            '    if (result.format !== "builtin") throw new Error("CJS nextResolve did not report node: builtin format: " + result.format);',
            '    return result;',
            '  }',
            ...
            '        "module.exports.modulePaths = module.paths.slice();",',
            '        "module.exports.moduleParentNull = module.parent === null;",',
            '        "module.exports.loadedDuringEvaluation = module.loaded;",',
            '        "module.exports.getLoaded = () => module.loaded;",',
            ...
            '        "module.exports.parentToken = 91;",',
            '        "const child = require(\\"virtual:child\\");",',
            '        "module.exports.childValue = child.value;",',
            '        "module.exports.childParentToken = child.parentToken;",',
            '        "module.exports.childCount = module.children.filter((item) => item.exports.value === 123).length;",',
            '        "let retryError; try { require(\\"virtual:loader-cjs-retry\\"); } catch (error) { retryError = error.message; }",',
            '        "module.exports.retryError = retryError;",',
            '        "module.exports.retryAttempt = require(\\"virtual:loader-cjs-retry\\").attempt;",',
            '        "module.exports.retryChildCount = module.children.filter((item) => item.exports.attempt === 2).length;",',
            ...
            '        "module.exports.aliasFsNextBareReadFile = require(\\"alias-fs-next-bare\\").readFile;",',
            '        "module.exports.aliasFsNextBareResolved = require.resolve(\\"alias-fs-next-bare\\");",',
            '        "module.exports.aliasFsNextNodeReadFile = require(\\"alias-fs-next-node\\").readFile;",',
            '        "module.exports.aliasFsNextNodeResolved = require.resolve(\\"alias-fs-next-node\\");",',
            ...
            '    return { shortCircuit: true, format: "commonjs", source: sourceView("exports.value = 123; exports.fromView = true; exports.parentToken = module.parent && module.parent.exports.parentToken; exports.conditions = " + JSON.stringify(context.conditions) + ";") };',
            '  }',
            '  if (url === "virtual:loader-cjs-retry") {',
            '    return { shortCircuit: true, format: "commonjs", source: "globalThis.__loaderCjsRetryAttempt = (globalThis.__loaderCjsRetryAttempt || 0) + 1; if (globalThis.__loaderCjsRetryAttempt === 1) throw new Error(\\"loader retry\\"); exports.attempt = globalThis.__loaderCjsRetryAttempt;" };',
            '  }',
            '  if (url === "virtual:missing-file-url-fallback") {',
            '    return { shortCircuit: true, format: "commonjs", source: "module.exports = true;" };',
            '  }',
            '  if (url === "virtual:loader-cjs-cycle-a") {',
            '    return { shortCircuit: true, format: "commonjs", source: "exports.phase = \\"a-start\\"; const b = require(\\"virtual:loader-cjs-cycle-b\\"); exports.seen = b.seen; exports.loadedDuring = module.loaded; exports.parentNull = module.parent === null; exports.getLoaded = () => module.loaded; exports.phase = \\"a-done\\";" };',
            '  }',
            '  if (url === "virtual:loader-cjs-cycle-b") {',
            '    return { shortCircuit: true, format: "commonjs", source: "exports.seen = require(\\"virtual:loader-cjs-cycle-a\\").phase; exports.parentPhase = module.parent && module.parent.exports.phase;" };',
            '  }',
            ...
            '  }',
            '  if (url === "file:///loader-cjs-source-app/member-reexport.cjs") {',
            '    return { shortCircuit: true, format: "commonjs", source: "const holder = { require() { return { local: \\"local\\" }; } }; module.exports = holder. /* member require */ require(\\"./reexport-dep.cjs\\");" };',
            '  }',
            '  if (url === "file:///loader-cjs-source-app/member-define-property.cjs") {',
            '    return { shortCircuit: true, format: "commonjs", source: "const holder = { Object: { defineProperty() {} } }; holder. /* member Object */ Object.defineProperty(exports, \\"ghost\\", { value: \\"ghost\\" }); exports.real = \\"real\\";" };',
            '  }',
            '  if (url === "file:///loader-cjs-source-app/member-exports.cjs") {',
            '    return { shortCircuit: true, format: "commonjs", source: "const holder = { exports: {} }; holder. /* member exports */ exports.foo = 1;" };',
            '  }',
            '  if (url === "file:///loader-cjs-source-app/member-module.cjs") {',
            '    return { shortCircuit: true, format: "commonjs", source: "const holder = { module: { exports: {} } }; holder. /* member module */ module.exports.foo = 1;" };',
            '  }',
            ...
            '      format: "commonjs",',
            '      source: [',
            '        "const holder = { require() { return {}; } };",',
            '        "var dep = holder. /* member require binding */ require(\\"./reexport-dep.cjs\\");",',
            '        "Object.keys(dep).forEach(function (key) {",',
            '        "  if (key === \\"default\\" || key === \\"__esModule\\") return;",',
            '        "  exports[key] = dep[key];",',
            '        "});",',
            ...
            '    };',
            '  }',
            '  if (url === "file:///loader-cjs-source-app/keys-asi-unary.cjs") {',
            '    return {',
            '      shortCircuit: true,',
            '      format: "commonjs",',
            '      source: [',
            ...
            '    };',
            '  }',
            '  if (url === "file:///loader-cjs-source-app/keys-rhs-member.cjs") {',
            '    return {',
            '      shortCircuit: true,',
            '      format: "commonjs",',
            '      source: [',
            ...
            '        "Object.keys(dep).forEach(function (key) {",',
            '        "  if (key === \\"default\\" || key === \\"__esModule\\") return;",',
            '        "  exports[key] = dep[key] /* comment */ .nested;",',
            '        "});",',
            '        "Object.keys(dep).forEach(function (key) {",',
            '        "  if (key === \\"default\\" || key === \\"__esModule\\") return;",',
            '        "  exports[key] = dep[key][\\"nested\\"];",',
            ...
            'assert.deepStrictEqual(ns.modulePaths, ["/node_modules"]);',
            'assert.strictEqual(ns.moduleParentNull, true);',
            'assert.strictEqual(ns.loadedDuringEvaluation, false);',
            'assert.strictEqual(ns.default.getLoaded(), true);',
            ...
            'assert.strictEqual(ns.childParentToken, 91);',
            'assert.strictEqual(ns.childCount, 1);',
            'assert.strictEqual(ns.retryError, "loader retry");',
            'assert.strictEqual(ns.retryAttempt, 2);',
            'assert.strictEqual(ns.retryChildCount, 1);',
            'const cycle = await import("virtual:loader-cjs-cycle-a");',
            'assert.strictEqual(cycle.seen, "a-start");',
            'assert.strictEqual(cycle.default.loadedDuring, false);',
            'assert.strictEqual(cycle.default.parentNull, true);',
            'assert.strictEqual(cycle.default.getLoaded(), true);',
            ...
            'assert.strictEqual(typeof ns.aliasFsNextBareReadFile, "function");',
            'assert.strictEqual(ns.aliasFsNextBareResolved, "fs");',
            'assert.strictEqual(typeof ns.aliasFsNextNodeReadFile, "function");',
            'assert.strictEqual(ns.aliasFsNextNodeResolved, "fs");',
            ...
            'assert.strictEqual(continuationReexport.nested, undefined);',
            'const memberReexport = await import("virtual:loader-cjs-member-reexport");',
            'assert.strictEqual(memberReexport.default.local, "local");',
            'assert.strictEqual(Object.prototype.hasOwnProperty.call(memberReexport, "reexported"), false);',
            'const memberDefineProperty = await import("virtual:loader-cjs-member-define-property");',
            'assert.strictEqual(memberDefineProperty.real, "real");',
            'assert.strictEqual(Object.prototype.hasOwnProperty.call(memberDefineProperty, "ghost"), true);',
            'assert.strictEqual(memberDefineProperty.ghost, undefined);',
            'const memberExports = await import("virtual:loader-cjs-member-exports");',
            'assert.strictEqual(Object.prototype.hasOwnProperty.call(memberExports, "foo"), true);',
            'assert.strictEqual(memberExports.foo, undefined);',
            'const memberModule = await import("virtual:loader-cjs-member-module");',
            'assert.strictEqual(Object.prototype.hasOwnProperty.call(memberModule, "foo"), true);',
            'assert.strictEqual(memberModule.foo, undefined);',
            ...
            'const keysAsiUnary = await import("virtual:loader-cjs-keys-asi-unary");',
            'assert.strictEqual(keysAsiUnary.reexported, 91);',
            'assert.strictEqual(keysAsiUnary.own, "own-value");',
            ...
            'const keysRhsMember = await import("virtual:loader-cjs-keys-rhs-member");',
            'assert.strictEqual(keysRhsMember.default.nestedValue, undefined);',
            'assert.strictEqual(keysRhsMember.own, "own-value");',
            'assert.strictEqual(Object.prototype.hasOwnProperty.call(keysRhsMember, "nestedValue"), false);',
...
export const testLoaderCommonjsJsonCache = async () => {
    const hookSource = [
        ...
        '  if (specifier === "virtual:json-parent" || specifier === "virtual:json-child" || specifier === "virtual:json-load-count") {',
        ...
        '      "const hookLoads = require(\\"virtual:json-load-count\\");",',
        ...
        '  }',
        '  if (url === "virtual:json-load-count") {',
        '    return { shortCircuit: true, format: "commonjs", source: "module.exports = " + jsonLoads };',
        '  }',
...
export const testCjsPackageJsonParseCache = async () => {
    try {
        ...
        fs.writeFileSync(`${probeRoot}/session.cjs`, [
            ...
            '  Module._pathCache = Object.create(null);',
            '  const missingPathHitsBefore = globalThis.__wasm_rquickjs_get_cjs_module_probe_session_hit_count();',
            '  assert.throws(() => require.resolve("./late"), { code: "MODULE_NOT_FOUND" });',
            '  assert.ok(',
            '    globalThis.__wasm_rquickjs_get_cjs_module_probe_session_hit_count() > missingPathHitsBefore,',
            '    "the repeated missing path lookup must use the outer CommonJS session",',
            '  );',
