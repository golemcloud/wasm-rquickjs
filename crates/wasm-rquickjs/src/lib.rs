...
///
/// [`GenerationTarget::WasiP3`] is the opt-in Preview 3 path (Phase 1). It uses the
...
/// **async freestanding** WIT exports and imports. Synchronous exports, resources,
/// Wizer and composition are rejected in this mode for now.
