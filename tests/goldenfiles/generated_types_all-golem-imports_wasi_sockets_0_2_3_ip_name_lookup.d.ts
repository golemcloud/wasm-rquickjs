declare module 'wasi:sockets/ip-name-lookup@0.2.3' {
  ...
  export type ErrorCode = wasiSockets023Network.ErrorCode;
  export type IpAddress = wasiSockets023Network.IpAddress;
