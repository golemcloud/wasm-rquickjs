...
const nodeBuiltins = [
  'assert', 'async_hooks', 'buffer', 'child_process', 'crypto', 'dgram', 'diagnostics_channel',
  'dns', 'events', 'fs', 'http', 'http2', 'https', 'inspector', 'module', 'net', 'os', 'path',
  'perf_hooks', 'querystring', 'readline', 'stream', 'string_decoder', 'tls', 'url', 'util',
