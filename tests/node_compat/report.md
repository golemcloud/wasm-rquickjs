...
Generated: 2026-03-08 | Runtime: 11894s | Engine: wasm-rquickjs (QuickJS)
...
- `parallel/test-child-process-exec-abortcontroller-promisified.js#block_03_block_03`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:25:10)     at loadModule (node:module:666:24)     at localRequire (node:modu...
- `parallel/test-child-process-exec-abortcontroller-promisified.js#block_04_block_04`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:28:10)     at loadModule (node:module:666:24)     at localRequire (node:modu...
...
- `parallel/test-child-process-exec-maxbuf.js`: cannot read property 'setEncoding' of null     at <anonymous> (<input>:122:3)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-child-process-exec-maxbuf.js#block_08_block_08`: cannot read property 'setEncoding' of null     at <anonymous> (<input>:61:3)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-child-process-exec-maxbuf.js#block_09_block_09`: cannot read property 'setEncoding' of null     at <anonymous> (<input>:63:3)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-child-process-execFile-promisified-abortController.js#block_02_block_02`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:24:10)     at loadModule (node:module:666:24)     at localRequire (node:modu...
- `parallel/test-child-process-execFile-promisified-abortController.js#block_03_block_03`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:26:10)     at loadModule (node:module:666:24)     at localRequire (node:modu...
- `parallel/test-child-process-execfile-maxbuf.js#block_06_block_06`: cannot read property 'setEncoding' of null     at <anonymous> (<input>:38:3)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-child-process-execfile-maxbuf.js#block_07_block_07`: cannot read property 'setEncoding' of null     at <anonymous> (<input>:40:3)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-child-process-execfile.js#block_05_block_05`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:28:10)     at loadModule (node:module:666:24)     at localRequire (node:modu...
...
- `parallel/test-child-process-execfilesync-maxbuf.js#block_00_verify_that_an_error_is_returned_if_maxbuffer_is_surpassed`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:20:10)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTes...
- `parallel/test-child-process-execfilesync-maxbuf.js#block_02_default_maxbuffer_size_is_1024_1024`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:26:10)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTes...
...
- `parallel/test-child-process-spawnsync-maxbuf.js#block_00_verify_that_an_error_is_returned_if_maxbuffer_is_surpassed`: maxBuffer should error AssertionError: maxBuffer should error     at <anonymous> (<input>:22:13)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-co...
- `parallel/test-child-process-spawnsync-maxbuf.js#block_02_default_maxbuffer_size_is_1024_1024`: maxBuffer should error AssertionError: maxBuffer should error     at <anonymous> (<input>:29:13)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-co...
...
- `parallel/test-child-process-spawnsync.js#block_00_block_00`: Expected values to be strictly equal:  null !== 0  AssertionError: Expected values to be strictly equal:  null !== 0      at <anonymous> (<input>:34:20)     at loadModule (node:module:666:24)     at l...
- `parallel/test-child-process-spawnsync.js#block_01_block_01`: Expected values to be strictly equal:  null !== 0  AssertionError: Expected values to be strictly equal:  null !== 0      at <anonymous> (<input>:34:20)     at loadModule (node:module:666:24)     at l...
...
- `parallel/test-crypto-dh-modp2.js#block_01_block_01`: No private key set     at <anonymous> (__wasm_rquickjs_builtin/web_crypto:2281:25)     at <anonymous> (<input>:17:51)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)   ...
- `parallel/test-crypto-dh-modp2.js#block_02_block_02`: No private key set     at <anonymous> (__wasm_rquickjs_builtin/web_crypto:2281:25)     at <anonymous> (<input>:19:51)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)   ...
...
- `parallel/test-crypto-sign-verify.js#block_11_block_11`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:74:5)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest...
...
- `parallel/test-crypto-sign-verify.js#block_17_block_17`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:175:12)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTe...
...
- `parallel/test-dgram-close-signal.js#block_00_block_00`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:10:5)     at loadModule (node:module:666:24)     at localRequire (node:modul...
...
- `parallel/test-dns-setlocaladdress.js`: Missing expected exception (Error). AssertionError: Missing expected exception (Error).     at <anonymous> (<input>:19:10)     at loadModule (node:module:666:24)     at localRequire (node:module:762:3...
- `parallel/test-dns-setlocaladdress.js#block_01_verify_that_setlocaladdress_throws_if_called_with_an_invalid`: Missing expected exception (Error). AssertionError: Missing expected exception (Error).     at <anonymous> (<input>:14:10)     at loadModule (node:module:666:24)     at localRequire (node:module:762:3...
...
- `parallel/test-file.js#block_02_block_02`: Expected values to be strictly equal:  false !== true  AssertionError: Expected values to be strictly equal:  false !== true      at <anonymous> (<input>:21:24)     at loadModule (node:module:666:24) ...
...
- `parallel/test-file.js#block_07_block_07`: Unhandled promise rejection:     at text (__wasm_rquickjs_builtin/http_blob:116:45)     at call (native)     at <anonymous> (<input>:26:23)     at loadModule (node:module:666:24)     at localRequire (...
- `parallel/test-file.js#block_10_block_10`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:41:12)     at loadModule (node:module:666:24)     at localRequire (node:modu...
...
- `parallel/test-file.js#block_14_block_14`: Expected values to be strictly equal:  2 !== 1  AssertionError: Expected values to be strictly equal:  2 !== 1      at <anonymous> (<input>:44:22)     at loadModule (node:module:666:24)     at localRe...
...
- `parallel/test-fs-readfile.js#block_03_block_03`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:63:10)     at loadModule (node:module:666:24)     at localRequire (node:modu...
...
- `parallel/test-fs-statfs.js#block_00_synchronous`: not a function     at <anonymous> (<input>:18:42)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-fs-statfs.js#block_01_synchronous_bigint`: not a function     at <anonymous> (<input>:18:42)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-fs-stream-options.js#block_00_block_00`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:11:5)     at loadModule (node:module:666:24)     at localRequire (node:modul...
- `parallel/test-fs-stream-options.js#block_01_block_01`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:13:5)     at loadModule (node:module:666:24)     at localRequire (node:modul...
...
- `parallel/test-fs-write-file-sync.js#block_00_test_writefilesync`: Expected values to be strictly equal:  420 !== 493  AssertionError: Expected values to be strictly equal:  420 !== 493      at <anonymous> (<input>:50:47)     at loadModule (node:module:666:24)     at...
- `parallel/test-fs-write-file-sync.js#block_01_test_appendfilesync`: Expected values to be strictly equal:  420 !== 493  AssertionError: Expected values to be strictly equal:  420 !== 493      at <anonymous> (<input>:53:47)     at loadModule (node:module:666:24)     at...
- `parallel/test-fs-write-file-sync.js#block_02_test_writefilesync_with_file_descriptor`: Expected values to be strictly equal:  420 !== 493  AssertionError: Expected values to be strictly equal:  420 !== 493      at <anonymous> (<input>:74:47)     at loadModule (node:module:666:24)     at...
...
- `parallel/test-fs-write-file-sync.js#block_04_test_writefilesync_with_no_flags`: Only 'utf8' encoding is supported     at writeFileSync (node:fs:1053:23)     at <anonymous> (<input>:64:22)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTe...
...
- `parallel/test-fs-write.js#block_00_block_00`: Expected "actual" to be strictly unequal to:  undefined AssertionError: Expected "actual" to be strictly unequal to:  undefined     at <anonymous> (<input>:44:23)     at loadModule (node:module:666:24...
- `parallel/test-fs-write.js#block_01_block_01`: Expected "actual" to be strictly unequal to:  undefined AssertionError: Expected "actual" to be strictly unequal to:  undefined     at <anonymous> (<input>:44:23)     at loadModule (node:module:666:24...
- `parallel/test-fs-write.js#block_02_block_02`: Expected "actual" to be strictly unequal to:  undefined AssertionError: Expected "actual" to be strictly unequal to:  undefined     at <anonymous> (<input>:44:23)     at loadModule (node:module:666:24...
- `parallel/test-fs-write.js#block_03_block_03`: Expected "actual" to be strictly unequal to:  undefined AssertionError: Expected "actual" to be strictly unequal to:  undefined     at <anonymous> (<input>:44:23)     at loadModule (node:module:666:24...
- `parallel/test-fs-write.js#block_04_block_04`: Expected "actual" to be strictly unequal to:  undefined AssertionError: Expected "actual" to be strictly unequal to:  undefined     at <anonymous> (<input>:44:23)     at loadModule (node:module:666:24...
...
- `sequential/test-fs-watch.js#block_01_block_01`: ENOENT: no such file or directory, chdir '/' -> '/tmp/w'     at chdir (node:process:328:112)     at <anonymous> (<input>:61:17)     at loadModule (node:module:666:24)     at localRequire (node:module:...
...
- `parallel/test-http-agent-destroyed-socket.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:31:25)     at loadModule (node:mod...
- `parallel/test-http-agent-error-on-idle.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:12:8)     at loadModule (node:modu...
- `parallel/test-http-agent-maxsockets-respected.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:42:10)     at loadModule (node:mod...
- `parallel/test-http-agent-maxsockets.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:47:25)     at loadModule (node:mod...
- `parallel/test-http-agent-maxtotalsockets.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at start (<input>:95:27)     at forEach (native)     at <a...
...
- `parallel/test-http-agent-remove.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:11:18)     at loadModule (node:mod...
- `parallel/test-http-agent-timeout.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:16:27)     at loadModule (node:mod...
...
- `parallel/test-http-byteswritten.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:53:12)     at loadModule (node:mod...
- `parallel/test-http-chunk-extensions-limit.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:24:10)     at loadModule (node:mod...
...
- `parallel/test-http-client-abort-no-agent.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:8:25)     at loadModule (node:modu...
- `parallel/test-http-client-abort-response-event.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:9:34)     at loadModule (node:modu...
...
- `parallel/test-http-client-aborted-event.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:12:36)     at loadModule (node:mod...
...
- `parallel/test-http-client-agent-abort-close-event.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:10:25)     at loadModule (node:mod...
...
- `parallel/test-http-client-response-timeout.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:7:22)     at loadModule (node:modu...
...
- `parallel/test-http-conn-reset.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:39:48)     at loadModule (node:mod...
- `parallel/test-http-content-length-mismatch.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at shouldThrowOnMoreBytes (<input>:21:10)     at <anonymou...
...
- `parallel/test-http-decoded-auth.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:43:10)     at loadModule (node:mod...
...
- `parallel/test-http-early-hints.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:22:27)     at loadModule (node:mod...
...
- `parallel/test-http-flush-response-headers.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:13:8)     at loadModule (node:modu...
- `parallel/test-http-get-pipeline-problem.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:60:8)     at loadModule (node:modu...
...
- `parallel/test-http-keep-alive-pipeline-max-requests.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:51:25)     at loadModule (node:mod...
...
- `parallel/test-http-outgoing-finish-writable.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:24:8)     at loadModule (node:modu...
...
- `parallel/test-http-outgoing-message-capture-rejection.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:27:27)     at loadModule (node:mod...
...
- `parallel/test-http-pause-resume-one-end.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:33:34)     at loadModule (node:mod...
...
- `parallel/test-http-pipeline-socket-parser-typeerror.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:50:4)     at loadModule (node:modu...
- `parallel/test-http-readable-data-event.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:24:4)     at loadModule (node:modu...
...
- `parallel/test-http-request-dont-override-options.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:13:8)     at loadModule (node:modu...
...
- `parallel/test-http-request-host-header.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:15:27)     at loadModule (node:mod...
...
- `parallel/test-http-request-join-authorization-headers.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:17:27)     at loadModule (node:mod...
...
- `parallel/test-http-request-method-delete-payload.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:22:25)     at loadModule (node:mod...
...
- `parallel/test-http-request-smuggling-content-length.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:13:34)     at loadModule (node:mod...
- `parallel/test-http-res-write-end-dont-take-array.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:63:8)     at loadModule (node:modu...
- `parallel/test-http-response-add-header-after-sent.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:20:8)     at loadModule (node:modu...
- `parallel/test-http-response-close.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:36:12)     at loadModule (node:mod...
...
- `parallel/test-http-response-cork.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:26:8)     at loadModule (node:modu...
...
- `parallel/test-http-response-readable.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:32:12)     at loadModule (node:mod...
- `parallel/test-http-response-remove-header-after-sent.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:20:8)     at loadModule (node:modu...
- `parallel/test-http-response-setheaders.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:18:27)     at loadModule (node:mod...
...
- `parallel/test-http-server-delete-parser.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:15:38)     at loadModule (node:mod...
- `parallel/test-http-server-keep-alive-defaults.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:43:25)     at loadModule (node:mod...
- `parallel/test-http-server-keep-alive-max-requests-null.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:44:25)     at loadModule (node:mod...
...
- `parallel/test-http-server-keepalive-end.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:24:25)     at loadModule (node:mod...
...
- `parallel/test-http-server-unconsume-consume.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:14:29)     at loadModule (node:mod...
...
- `parallel/test-http-timeout-client-warning.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:14:22)     at loadModule (node:mod...
- `parallel/test-http-timeout-overflow.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:31:8)     at loadModule (node:modu...
...
- `parallel/test-http-transfer-encoding-repeated-chunked.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:31:25)     at loadModule (node:mod...
- `parallel/test-http-transfer-encoding-smuggling.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:31:27)     at loadModule (node:mod...
...
- `parallel/test-http-write-empty-string.js`: Unhandled promise rejection:     at parseNativeError (node:net:77:25)     at doListen (node:net:1070:42)     at listen (node:net:1079:31)     at <anonymous> (<input>:41:25)     at loadModule (node:mod...
...
- `parallel/test-http2-perform-server-handshake.js#block_01_double_bind_should_fail`: not a function     at <anonymous> (<input>:23:32)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `es-module/test-require-module-conditional-exports.js#block_00_if_only_require_exports_are_defined_return_require_exports`: Cannot find module 'dep'     at localRequire (node:module:773:59)     at <anonymous> (<input>:1:79)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at <anonymous> (...
...
- `es-module/test-require-module-cycle-esm-cjs-esm-esm.js#block_00_a_mjs_b_cjs_c_mjs_a_mjs`: - stderr did not match /Cannot import Module \.\/a\.mjs in a cycle\. \(from .*c\.mjs\)/     at <anonymous> (<input>:13:16)     at loadModule (node:module:666:24)     at localRequire (node:module:762:3...
- `es-module/test-require-module-cycle-esm-cjs-esm-esm.js#block_01_b_cjs_c_mjs_a_mjs_b_cjs`: - stderr did not match /Cannot import CommonJS Module \.\/b\.cjs in a cycle\. \(from .*a\.mjs\)/     at <anonymous> (<input>:16:16)     at loadModule (node:module:666:24)     at localRequire (node:mod...
- `es-module/test-require-module-cycle-esm-cjs-esm-esm.js#block_02_c_mjs_a_mjs_b_cjs_c_mjs`: - stderr did not match /Cannot require\(\) ES Module .*c\.mjs in a cycle\. \(from .*b\.cjs\)/     at <anonymous> (<input>:19:16)     at loadModule (node:module:666:24)     at localRequire (node:module...
- `es-module/test-require-module-cycle-esm-cjs-esm.js#block_00_require_a_cjs_a_mjs_b_cjs_a_mjs`: - stderr did not match /Cannot require\(\) ES Module .*a\.mjs in a cycle\. \(from .*require-a\.cjs\)/     at <anonymous> (<input>:13:16)     at loadModule (node:module:666:24)     at localRequire (nod...
- `es-module/test-require-module-cycle-esm-cjs-esm.js#block_01_require_b_cjs_b_cjs_a_mjs_b_cjs`: - stderr did not match /Cannot import CommonJS Module \.\/b\.cjs in a cycle\. \(from .*a\.mjs\)/     at <anonymous> (<input>:16:16)     at loadModule (node:module:666:24)     at localRequire (node:mod...
- `es-module/test-require-module-cycle-esm-cjs-esm.js#block_02_a_mjs_b_cjs_a_mjs`: - stderr did not match /Cannot require\(\) ES Module .*a\.mjs in a cycle\. \(from .*b\.cjs\)/     at <anonymous> (<input>:19:16)     at loadModule (node:module:666:24)     at localRequire (node:module...
- `es-module/test-require-module-cycle-esm-cjs-esm.js#block_03_b_cjs_a_mjs_b_cjs`: - stderr did not match /Cannot import CommonJS Module \.\/b\.cjs in a cycle\. \(from .*a\.mjs\)/     at <anonymous> (<input>:22:16)     at loadModule (node:module:666:24)     at localRequire (node:mod...
- `es-module/test-require-module-cycle-esm-esm-cjs-esm-esm.js#block_00_a_mjs_b_mjs_c_cjs_z_mjs_a_mjs`: - stderr did not match /Cannot import Module \.\/a\.mjs in a cycle\. \(from .*z\.mjs\)/     at <anonymous> (<input>:13:16)     at loadModule (node:module:666:24)     at localRequire (node:module:762:3...
- `es-module/test-require-module-cycle-esm-esm-cjs-esm-esm.js#block_01_b_mjs_c_cjs_z_mjs_a_mjs_b_mjs`: - stderr did not match /Cannot import Module \.\/b\.mjs in a cycle\. \(from .*a\.mjs\)/     at <anonymous> (<input>:16:16)     at loadModule (node:module:666:24)     at localRequire (node:module:762:3...
- `es-module/test-require-module-cycle-esm-esm-cjs-esm-esm.js#block_02_c_cjs_z_mjs_a_mjs_b_mjs_c_cjs`: - stderr did not match /Cannot import CommonJS Module \.\/c\.cjs in a cycle\. \(from .*b\.mjs\)/     at <anonymous> (<input>:19:16)     at loadModule (node:module:666:24)     at localRequire (node:mod...
- `es-module/test-require-module-cycle-esm-esm-cjs-esm-esm.js#block_03_z_mjs_a_mjs_b_mjs_c_cjs_z_mjs`: - stderr did not match /Cannot require\(\) ES Module .*z\.mjs in a cycle\. \(from .*c\.cjs\)/     at <anonymous> (<input>:23:16)     at loadModule (node:module:666:24)     at localRequire (node:module...
- `es-module/test-require-module-cycle-esm-esm-cjs-esm.js#block_00_a_mjs_b_mjs_c_mjs_d_mjs_c_mjs`: - process terminated with status 1, expected 0     at <anonymous> (<input>:14:16)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146...
- `es-module/test-require-module-cycle-esm-esm-cjs-esm.js#block_01_b_mjs_c_mjs_d_mjs_c_mjs`: - stderr did not match /Cannot import Module \.\/c\.mjs in a cycle\. \(from .*d\.mjs\)/ - stdout did not match /Start c/     at <anonymous> (<input>:17:16)     at loadModule (node:module:666:24)     a...
- `es-module/test-require-module-cycle-esm-esm-cjs-esm.js#block_02_c_mjs_d_mjs_c_mjs`: - stderr did not match /Cannot import Module \.\/c\.mjs in a cycle\. \(from .*d\.mjs\)/ - stdout did not match /Start c/     at <anonymous> (<input>:20:16)     at loadModule (node:module:666:24)     a...
- `es-module/test-require-module-cycle-esm-esm-cjs-esm.js#block_03_d_mjs_c_mjs_d_mjs`: - stderr did not match /Cannot require\(\) ES Module .*d\.mjs in a cycle\. \(from .*c\.mjs\)/ - stdout did not match /Start c/     at <anonymous> (<input>:24:16)     at loadModule (node:module:666:24)...
- `es-module/test-require-module-defined-esmodule.js#block_00_require_esm_should_allow_the_user_override`: unsupported keyword: export     at <input>:1:10     at eval (native)     at compileCjs (node:module:597:22)     at loadModule (node:module:654:37)     at localRequire (node:module:762:34)     at <anon...
- `es-module/test-require-module-defined-esmodule.js#block_01_block_01`: unsupported keyword: export     at <input>:1:10     at eval (native)     at compileCjs (node:module:597:22)     at loadModule (node:module:654:37)     at localRequire (node:module:762:34)     at <anon...
...
- `es-module/test-require-module-with-detection.js#block_00_block_00`: unsupported keyword: export     at <input>:4:10     at eval (native)     at compileCjs (node:module:597:22)     at loadModule (node:module:654:37)     at localRequire (node:module:762:34)     at <anon...
- `es-module/test-require-module-with-detection.js#block_01_block_01`: unsupported keyword: export     at <input>:2:10     at eval (native)     at compileCjs (node:module:597:22)     at loadModule (node:module:654:37)     at localRequire (node:module:762:34)     at <anon...
- `es-module/test-require-module.js#block_00_test_named_exports`: unsupported keyword: export     at <input>:1:10     at eval (native)     at compileCjs (node:module:597:22)     at loadModule (node:module:654:37)     at localRequire (node:module:762:34)     at <anon...
- `es-module/test-require-module.js#block_01_test_esm_that_import_esm`: Unexpected token '{'     at <input>:1:10     at eval (native)     at compileCjs (node:module:597:22)     at loadModule (node:module:654:37)     at localRequire (node:module:762:34)     at <anonymous> ...
- `es-module/test-require-module.js#block_02_test_esm_that_import_cjs`: Unexpected token '{'     at <input>:1:10     at eval (native)     at compileCjs (node:module:597:22)     at loadModule (node:module:654:37)     at localRequire (node:module:762:34)     at <anonymous> ...
- `es-module/test-require-module.js#block_03_test_esm_that_require_cjs`: unsupported keyword: export     at <input>:63:7     at eval (native)     at compileCjs (node:module:597:22)     at loadModule (node:module:654:37)     at localRequire (node:module:762:34)     at <anon...
- `es-module/test-require-module.js#block_04_also_test_default_export`: Unexpected string     at <input>:1:10     at eval (native)     at compileCjs (node:module:597:22)     at loadModule (node:module:654:37)     at localRequire (node:module:762:34)     at <anonymous> (<i...
- `es-module/test-require-module.js#block_05_test_data_import`: unsupported keyword: export     at <input>:1:10     at eval (native)     at compileCjs (node:module:597:22)     at loadModule (node:module:654:37)     at localRequire (node:module:762:34)     at <anon...
...
- `parallel/test-require-extension-over-directory.js`: Cannot find module '/test/fixtures/module-extension-over-directory/inner/' from '/test/parallel'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous>...
...
- `parallel/test-net-connect-immediate-destroy.js`: cannot read property 'port' of null     at <anonymous> (<input>:7:21)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-net-connect-options-port.js#block_02_test_invalid_hints`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:41:19)     at loadModule (node:module:666:24)     at localRequire (node:modu...
...
- `parallel/test-net-server-call-listen-multiple-times.js#block_01_second_test_check_that_second_listen_call_throws_an_error`: Missing expected exception (Error). AssertionError: Missing expected exception (Error).     at <anonymous> (<input>:16:10)     at loadModule (node:module:666:24)     at localRequire (node:module:762:3...
...
- `parallel/test-net-server-listen-options-signal.js#block_00_block_00`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:10:5)     at loadModule (node:module:666:24)     at localRequire (node:modul...
...
- `parallel/test-net-socket-destroy-twice.js`: cannot read property 'port' of null     at <anonymous> (<input>:28:21)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-blocklist.js#block_00_block_00`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:16:12)     at forEach (native)     at <anonymous> (<input>:15:42)     at loadModule (node:module:666...
...
- `parallel/test-blocklist.js#block_03_block_03`: ::1 check failed AssertionError: ::1 check failed     at <anonymous> (<input>:31:19)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:...
- `parallel/test-blocklist.js#block_04_block_04`: ::1 check failed AssertionError: ::1 check failed     at <anonymous> (<input>:38:19)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:...
...
- `parallel/test-blocklist.js#block_10_block_10`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:34:10)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTes...
- `parallel/test-blocklist.js#block_11_block_11`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:36:10)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTes...
- `parallel/test-blocklist.js#block_12_block_12`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:38:10)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTes...
- `parallel/test-broadcastchannel-custom-inspect.js#block_00_block_00`: worker_threads is not supported in WebAssembly environment     at BroadcastChannel (node:worker_threads:234:19)     at <anonymous> (<input>:11:18)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-broadcastchannel-custom-inspect.js#block_01_block_01`: worker_threads is not supported in WebAssembly environment     at BroadcastChannel (node:worker_threads:234:19)     at <anonymous> (<input>:13:18)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-broadcastchannel-custom-inspect.js#block_02_block_02`: worker_threads is not supported in WebAssembly environment     at BroadcastChannel (node:worker_threads:234:19)     at <anonymous> (<input>:15:18)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-broadcastchannel-custom-inspect.js#block_03_block_03`: worker_threads is not supported in WebAssembly environment     at BroadcastChannel (node:worker_threads:234:19)     at <anonymous> (<input>:17:18)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-cli-permission-deny-fs.js#block_00_block_00`: Expected values to be strictly equal:  '' !== 'false'  AssertionError: Expected values to be strictly equal:  '' !== 'false'      at <anonymous> (<input>:23:22)     at loadModule (node:module:666:24) ...
- `parallel/test-cli-permission-deny-fs.js#block_01_block_01`: Expected values to be strictly equal:  '' !== 'false'  AssertionError: Expected values to be strictly equal:  '' !== 'false'      at <anonymous> (<input>:27:22)     at loadModule (node:module:666:24) ...
- `parallel/test-cli-permission-deny-fs.js#block_02_block_02`: Expected values to be strictly equal:  '' !== 'false'  AssertionError: Expected values to be strictly equal:  '' !== 'false'      at <anonymous> (<input>:28:22)     at loadModule (node:module:666:24) ...
- `parallel/test-cli-permission-deny-fs.js#block_03_block_03`: Expected values to be strictly equal:  '' !== 'false'  AssertionError: Expected values to be strictly equal:  '' !== 'false'      at <anonymous> (<input>:30:22)     at loadModule (node:module:666:24) ...
...
- `parallel/test-cli-permission-multiple-allow.js#block_00_block_00`: Expected values to be strictly equal:  '' !== 'false'  AssertionError: Expected values to be strictly equal:  '' !== 'false'      at <anonymous> (<input>:25:22)     at loadModule (node:module:666:24) ...
- `parallel/test-cli-permission-multiple-allow.js#block_01_block_01`: Expected values to be strictly equal:  '' !== 'false'  AssertionError: Expected values to be strictly equal:  '' !== 'false'      at <anonymous> (<input>:31:22)     at loadModule (node:module:666:24) ...
- `parallel/test-cli-permission-multiple-allow.js#block_02_block_02`: Expected values to be strictly equal:  '' !== 'false'  AssertionError: Expected values to be strictly equal:  '' !== 'false'      at <anonymous> (<input>:29:22)     at loadModule (node:module:666:24) ...
- `parallel/test-common.js#block_00_test_for_leaked_global_detection`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:44:15)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTes...
- `parallel/test-common.js#block_01_test_for_disabling_leaked_global_detection`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:46:15)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTes...
- `parallel/test-common.js#block_02_test_tmpdir`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:38:15)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTes...
- `parallel/test-common.js#block_03_must_be_last_since_it_uses_process_on_uncaughtexception`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:38:15)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTes...
...
- `parallel/test-freeze-intrinsics.js#block_00_ensure_we_can_extend_console`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:7:3)     at loadModule (node:module:666:24)     at localRequire (node:module...
- `parallel/test-freeze-intrinsics.js#block_01_ensure_we_can_write_override_object_prototype_properties_on_`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:7:3)     at loadModule (node:module:666:24)     at localRequire (node:module...
- `parallel/test-freeze-intrinsics.js#block_02_ensure_we_can_not_override_globalthis`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:7:3)     at loadModule (node:module:666:24)     at localRequire (node:module...
- `parallel/test-freeze-intrinsics.js#block_03_ensure_that_we_cannot_override_console_properties`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:7:3)     at loadModule (node:module:666:24)     at localRequire (node:module...
- `parallel/test-permission-allow-child-process-cli.js#block_00_guarantee_the_initial_state`: cannot read property 'has' of undefined     at <anonymous> (<input>:28:13)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-permission-allow-wasi-cli.js#block_00_guarantee_the_initial_state`: Cannot find module 'wasi'     at localRequire (node:module:773:59)     at <anonymous> (<input>:12:18)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (no...
- `parallel/test-permission-allow-wasi-cli.js#block_01_to_create_wasi_instance_unless_allow_wasi_is_sent`: Cannot find module 'wasi'     at localRequire (node:module:773:59)     at <anonymous> (<input>:12:18)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (no...
- `parallel/test-permission-allow-worker-cli.js#block_00_guarantee_the_initial_state`: cannot read property 'has' of undefined     at <anonymous> (<input>:14:13)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-permission-child-process-cli.js#block_00_guarantee_the_initial_state`: cannot read property 'has' of undefined     at <anonymous> (<input>:20:10)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-permission-fs-read.js`: AssertionError: Missing expected exception.     at <anonymous> (<input>:34:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runMain (node:module:987:23)     a...
- `parallel/test-permission-fs-read.js#block_01_block_01`: AssertionError: Missing expected exception.     at <anonymous> (<input>:34:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runMain (node:module:987:23)     a...
- `parallel/test-permission-fs-require.js`: 0 !== 1  AssertionError:   0 !== 1      at <anonymous> (<input>:46:40)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-permission-fs-require.js#block_01_block_01`: 0 !== 1  AssertionError:   0 !== 1      at <anonymous> (<input>:31:40)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-permission-fs-require.js#block_02_block_02`: Error: Unexpected string     at <input>:1:10     at eval (native)     at compileCjs (node:module:597:22)     at loadModule (node:module:654:37)     at localRequire (node:module:762:34)     at runMain ...
...
- `parallel/test-permission-fs-wildcard.js#block_00_block_00`: Error: Cannot find module '/tmp/*' from '/'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at runMain (node:module:987:23)     at runInline (node:child_proces...
- `parallel/test-permission-fs-wildcard.js#block_01_block_01`: Error: Cannot find module '/tmp/*' from '/'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at runMain (node:module:987:23)     at runInline (node:child_proces...
...
- `parallel/test-permission-has.js#block_00_block_00`: cannot read property 'has' of undefined     at <anonymous> (<input>:9:13)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-permission-has.js#block_01_block_01`: cannot read property 'has' of undefined     at <anonymous> (<input>:11:10)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-set-incoming-message-header.js#block_02_addheaderlines_function_set_a_header_correctly`: not a function     at <anonymous> (<input>:17:6)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-shadow-realm-preload-module.js`: Unhandled promise rejection:     at main (<input>:16:14)     at <anonymous> (<input>:20:1)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-r...
...
- `parallel/test-single-executable-blob-config-errors.js#block_03_block_03`: Expected values to be strictly equal:  0 !== 1  AssertionError: Expected values to be strictly equal:  0 !== 1      at <anonymous> (<input>:27:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-single-executable-blob-config-errors.js#block_04_block_04`: Expected values to be strictly equal:  0 !== 1  AssertionError: Expected values to be strictly equal:  0 !== 1      at <anonymous> (<input>:29:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-single-executable-blob-config-errors.js#block_05_block_05`: Expected values to be strictly equal:  0 !== 1  AssertionError: Expected values to be strictly equal:  0 !== 1      at <anonymous> (<input>:31:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-single-executable-blob-config-errors.js#block_06_block_06`: Expected values to be strictly equal:  0 !== 1  AssertionError: Expected values to be strictly equal:  0 !== 1      at <anonymous> (<input>:39:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-single-executable-blob-config-errors.js#block_07_block_07`: Expected values to be strictly equal:  0 !== 1  AssertionError: Expected values to be strictly equal:  0 !== 1      at <anonymous> (<input>:35:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-single-executable-blob-config-errors.js#block_08_block_08`: Expected values to be strictly equal:  0 !== 1  AssertionError: Expected values to be strictly equal:  0 !== 1      at <anonymous> (<input>:43:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-single-executable-blob-config-errors.js#block_09_block_09`: Expected values to be strictly equal:  0 !== 1  AssertionError: Expected values to be strictly equal:  0 !== 1      at <anonymous> (<input>:48:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-single-executable-blob-config-errors.js#block_10_block_10`: Expected values to be strictly equal:  0 !== 1  AssertionError: Expected values to be strictly equal:  0 !== 1      at <anonymous> (<input>:50:22)     at loadModule (node:module:666:24)     at localRe...
...
- `parallel/test-snapshot-api.js#block_00_block_00`: cannot read property 'isBuildingSnapshot' of undefined     at <anonymous> (<input>:16:1)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-run...
- `parallel/test-snapshot-api.js#block_01_block_01`: cannot read property 'isBuildingSnapshot' of undefined     at <anonymous> (<input>:16:1)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-run...
- `parallel/test-snapshot-argv1.js#block_00_block_00`: Expected values to be strictly equal:  1 !== 0  AssertionError: Expected values to be strictly equal:  1 !== 0      at <anonymous> (<input>:31:24)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-snapshot-argv1.js#block_01_block_01`: Unexpected end of JSON input     at <input>:1:1     at parse (native)     at <anonymous> (<input>:33:53)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest ...
- `parallel/test-snapshot-basic.js#block_00_by_default_the_snapshot_blob_path_is_cwd_snapshot_blob`: - process terminated with status 1, expected 9     at <anonymous> (<input>:24:20)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146...
- `parallel/test-snapshot-basic.js#block_01_block_01`: - process terminated with status 1, expected 9     at <anonymous> (<input>:24:20)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146...
- `parallel/test-snapshot-basic.js#block_02_block_02`: - process terminated with status 1, expected 9     at <anonymous> (<input>:24:20)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146...
- `parallel/test-snapshot-basic.js#block_03_block_03`: - process terminated with status 1, expected 9     at <anonymous> (<input>:24:20)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146...
- `parallel/test-snapshot-child-process-sync.js#block_00_block_00`: - process terminated with status 1, expected 0     at <anonymous> (<input>:23:22)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146...
- `parallel/test-snapshot-child-process-sync.js#block_01_block_01`: - process terminated with status 1, expected 0     at <anonymous> (<input>:24:22)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146...
- `parallel/test-snapshot-cjs-main.js#block_00_block_00`: Expected values to be strictly equal:  1 !== 0  AssertionError: Expected values to be strictly equal:  1 !== 0      at <anonymous> (<input>:31:24)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-snapshot-cjs-main.js#block_01_block_01`: Expected values to be strictly equal:  1 !== 0  AssertionError: Expected values to be strictly equal:  1 !== 0      at <anonymous> (<input>:33:24)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-snapshot-config.js#block_00_block_00`: - stderr did not match /Cannot read snapshot configuration from snapshot\.json/     at <anonymous> (<input>:23:20)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     a...
- `parallel/test-snapshot-config.js#block_01_block_01`: - stderr did not match /"builder" field of .+snapshot\.json is not a non-empty string/     at <anonymous> (<input>:31:20)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34...
- `parallel/test-snapshot-config.js#block_02_block_02`: - process terminated with status 1, expected 0     at <anonymous> (<input>:34:32)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146...
- `parallel/test-snapshot-config.js#block_03_block_03`: - process terminated with status 1, expected 0     at <anonymous> (<input>:37:32)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146...
- `parallel/test-snapshot-cwd.js#block_00_block_00`: - process terminated with status 1, expected 0     at <anonymous> (<input>:21:22)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146...
- `parallel/test-snapshot-cwd.js#block_01_block_01`: - process terminated with status 1, expected 0     at <anonymous> (<input>:22:22)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146...
- `parallel/test-snapshot-dns-lookup-localhost-promise.js#block_00_block_00`: Cannot find module '../common/snapshot' from '/test/parallel'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous> (<input>:9:44)     at loadModule (...
- `parallel/test-snapshot-dns-lookup-localhost-promise.js#block_01_block_01`: Cannot find module '../common/snapshot' from '/test/parallel'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous> (<input>:9:44)     at loadModule (...
- `parallel/test-snapshot-dns-lookup-localhost.js#block_00_block_00`: Cannot find module '../common/snapshot' from '/test/parallel'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous> (<input>:9:44)     at loadModule (...
- `parallel/test-snapshot-dns-lookup-localhost.js#block_01_block_01`: Cannot find module '../common/snapshot' from '/test/parallel'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous> (<input>:9:44)     at loadModule (...
- `parallel/test-snapshot-dns-resolve-localhost-promise.js#block_00_block_00`: Cannot find module '../common/snapshot' from '/test/parallel'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous> (<input>:9:44)     at loadModule (...
- `parallel/test-snapshot-dns-resolve-localhost-promise.js#block_01_block_01`: Cannot find module '../common/snapshot' from '/test/parallel'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous> (<input>:9:44)     at loadModule (...
- `parallel/test-snapshot-dns-resolve-localhost.js#block_00_block_00`: Cannot find module '../common/snapshot' from '/test/parallel'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous> (<input>:9:44)     at loadModule (...
- `parallel/test-snapshot-dns-resolve-localhost.js#block_01_block_01`: Cannot find module '../common/snapshot' from '/test/parallel'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous> (<input>:9:44)     at loadModule (...
- `parallel/test-snapshot-error.js#block_00_build_snapshot_should_be_run_with_an_entry_point`: Expected values to be strictly equal:  1 !== 9  AssertionError: Expected values to be strictly equal:  1 !== 9      at <anonymous> (<input>:30:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-snapshot-error.js#block_01_loading_a_non_existent_snapshot_should_fail`: Expected values to be strictly equal:  1 !== 14  AssertionError: Expected values to be strictly equal:  1 !== 14      at <anonymous> (<input>:33:22)     at loadModule (node:module:666:24)     at local...
- `parallel/test-snapshot-error.js#block_02_running_an_script_that_throws_an_error_should_result_in_an_e`: The input did not match the regular expression /error\.js:1/. Input:  "Error: Cannot find module '/tmp/w/snapshot.blob' from '/'\n" +   '    at resolveFilename (node:module:359:80)\n' +   '    at loca...
- `parallel/test-snapshot-eval.js#block_00_block_00`: Expected values to be strictly equal:  1 !== 0  AssertionError: Expected values to be strictly equal:  1 !== 0      at <anonymous> (<input>:30:24)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-snapshot-eval.js#block_01_block_01`: Expected values to be strictly equal:  1 !== 0  AssertionError: Expected values to be strictly equal:  1 !== 0      at <anonymous> (<input>:33:24)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-snapshot-eval.js#block_02_block_02`: Expected values to be strictly equal:  1 !== 0  AssertionError: Expected values to be strictly equal:  1 !== 0      at <anonymous> (<input>:35:24)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-snapshot-gzip.js#block_00_block_00`: Expected values to be strictly equal:  1 !== 0  AssertionError: Expected values to be strictly equal:  1 !== 0      at <anonymous> (<input>:36:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-snapshot-gzip.js#block_01_block_01`: Expected values to be strictly equal:  1 !== 0  AssertionError: Expected values to be strictly equal:  1 !== 0      at <anonymous> (<input>:36:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-snapshot-incompatible.js#block_00_is_chosen_here_because_it_s_stable_enough_and_makes_a_differ`: Expected values to be strictly equal:  1 !== 0  AssertionError: Expected values to be strictly equal:  1 !== 0      at <anonymous> (<input>:34:24)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-snapshot-incompatible.js#block_01_block_01`: The input did not match the regular expression /Failed to load the startup snapshot/. Input:  "Error: Cannot find module '/tmp/w/snapshot.blob' from '/'\n" +   '    at resolveFilename (node:module:359...
- `parallel/test-snapshot-incompatible.js#block_02_block_02`: Expected values to be strictly equal:  1 !== 0  AssertionError: Expected values to be strictly equal:  1 !== 0      at <anonymous> (<input>:40:24)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-snapshot-net.js#block_00_block_00`: Expected values to be strictly equal:  1 !== 0  AssertionError: Expected values to be strictly equal:  1 !== 0      at <anonymous> (<input>:28:24)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-snapshot-net.js#block_01_block_01`: Expected values to be strictly equal:  1 !== 0  AssertionError: Expected values to be strictly equal:  1 !== 0      at <anonymous> (<input>:33:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-snapshot-stack-trace-limit.js#block_00_block_00`: - process terminated with status 1, expected 0     at <anonymous> (<input>:20:14)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146...
- `parallel/test-snapshot-stack-trace-limit.js#block_01_block_01`: - process terminated with status 1, expected 0     at <anonymous> (<input>:17:22)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146...
- `parallel/test-snapshot-typescript.js#block_00_block_00`: Expected values to be strictly equal:  1 !== 0  AssertionError: Expected values to be strictly equal:  1 !== 0      at <anonymous> (<input>:37:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-snapshot-typescript.js#block_01_block_01`: Expected values to be strictly equal:  1 !== 0  AssertionError: Expected values to be strictly equal:  1 !== 0      at <anonymous> (<input>:41:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-snapshot-umd.js#block_00_block_00`: Expected values to be strictly equal:  1 !== 0  AssertionError: Expected values to be strictly equal:  1 !== 0      at <anonymous> (<input>:30:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-snapshot-umd.js#block_01_block_01`: Expected values to be strictly equal:  1 !== 0  AssertionError: Expected values to be strictly equal:  1 !== 0      at <anonymous> (<input>:35:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-snapshot-warning.js#block_00_block_00`: - process terminated with status 1, expected 0     at <anonymous> (<input>:22:32)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146...
- `parallel/test-snapshot-warning.js#block_01_block_01`: - process terminated with status 1, expected 0     at <anonymous> (<input>:26:22)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146...
- `parallel/test-snapshot-warning.js#block_02_block_02`: - process terminated with status 1, expected 0     at <anonymous> (<input>:31:22)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146...
...
- `parallel/test-source-map-api.js#block_01_findsourcemap_should_return_undefined_when_no_source_map_is_`: not a function     at <anonymous> (<input>:20:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-source-map-api.js#block_02_non_exceptional_case`: not a function     at <anonymous> (<input>:20:13)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-source-map-api.js#block_04_sourcemap_can_be_instantiated_with_source_map_v3_object_as_p`: not a function     at <anonymous> (<input>:31:25)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-source-map-api.js#block_05_error_when_receiving_a_malformed_mappings`: not a function     at <anonymous> (<input>:34:25)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-source-map-api.js#block_06_sourcemap_can_be_instantiated_with_index_source_map_v3_objec`: not a function     at <anonymous> (<input>:35:25)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-source-map-api.js#block_07_test_various_known_decodings_to_ensure_decodevlq_works_corre`: not a function     at <anonymous> (<input>:69:52)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-source-map-api.js#block_08_observed_see_https_github_com_mozilla_source_map_pull_92`: not a function     at <anonymous> (<input>:53:5)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-startup-large-pages.js#block_01_block_01`: Expected values to be strictly equal:  0 !== 9  AssertionError: Expected values to be strictly equal:  0 !== 9      at <anonymous> (<input>:14:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-webcrypto-constructors.js#block_00_test_cryptokey_constructor`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:13:10)     at loadModule (node:module:666:24)     at localRequire (node:modu...
...
- `parallel/test-webcrypto-constructors.js#block_03_test_crypto_prototype_subtle`: Crypto is not defined     at <anonymous> (<input>:20:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-webcrypto-constructors.js#block_04_test_crypto_prototype_randomuuid`: Crypto is not defined     at <anonymous> (<input>:20:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-webcrypto-constructors.js#block_05_test_crypto_prototype_getrandomvalues`: Crypto is not defined     at <anonymous> (<input>:20:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-webcrypto-constructors.js#block_06_test_subtlecrypto_prototype_encrypt`: Crypto is not defined     at <anonymous> (<input>:20:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-webcrypto-constructors.js#block_07_test_subtlecrypto_prototype_decrypt`: Crypto is not defined     at <anonymous> (<input>:20:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-webcrypto-constructors.js#block_08_test_subtlecrypto_prototype_sign`: Crypto is not defined     at <anonymous> (<input>:20:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-webcrypto-constructors.js#block_09_test_subtlecrypto_prototype_verify`: Crypto is not defined     at <anonymous> (<input>:20:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-webcrypto-constructors.js#block_10_test_subtlecrypto_prototype_digest`: Crypto is not defined     at <anonymous> (<input>:20:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-webcrypto-constructors.js#block_11_test_subtlecrypto_prototype_generatekey`: Crypto is not defined     at <anonymous> (<input>:20:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-webcrypto-constructors.js#block_12_test_subtlecrypto_prototype_derivekey`: Crypto is not defined     at <anonymous> (<input>:20:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-webcrypto-constructors.js#block_13_test_subtlecrypto_prototype_derivebits`: Crypto is not defined     at <anonymous> (<input>:20:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-webcrypto-constructors.js#block_14_test_subtlecrypto_prototype_importkey`: Crypto is not defined     at <anonymous> (<input>:20:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-webcrypto-constructors.js#block_15_test_subtlecrypto_prototype_exportkey`: Crypto is not defined     at <anonymous> (<input>:20:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-webcrypto-constructors.js#block_16_test_subtlecrypto_prototype_wrapkey`: Crypto is not defined     at <anonymous> (<input>:20:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-webcrypto-constructors.js#block_17_test_subtlecrypto_prototype_unwrapkey`: Crypto is not defined     at <anonymous> (<input>:20:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-webcrypto-constructors.js#block_18_block_18`: Crypto is not defined     at <anonymous> (<input>:20:37)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-webcrypto-encrypt-decrypt.js#block_00_test_encrypt_decrypt_rsa_oaep`: Unhandled promise rejection:     at generateKey (__wasm_rquickjs_builtin/web_crypto:7470:53)     at test (<input>:23:27)     at <anonymous> (<input>:42:3)     at loadModule (node:module:666:24)     at...
...
- `parallel/test-webcrypto-export-import-ec.js#block_00_block_00`: Unhandled promise rejection:     at importKey (__wasm_rquickjs_builtin/web_crypto:7586:82)     at <anonymous> (<input>:406:30)     at <anonymous> (<input>:410:1)     at loadModule (node:module:666:24)...
- `parallel/test-webcrypto-export-import-ec.js#block_01_bad_private_keys`: Unhandled promise rejection:     at importKey (__wasm_rquickjs_builtin/web_crypto:7586:82)     at <anonymous> (<input>:406:30)     at <anonymous> (<input>:410:1)     at loadModule (node:module:666:24)...
...
- `parallel/test-webcrypto-export-import.js#block_02_import_export_aes_secret_key`: Unhandled promise rejection:     at importKey (__wasm_rquickjs_builtin/web_crypto:7586:82)     at test (<input>:21:7)     at <anonymous> (<input>:57:3)     at loadModule (node:module:666:24)     at lo...
- `parallel/test-webcrypto-export-import.js#block_03_import_export_rsa_key_pairs`: Unhandled promise rejection:     at generateKey (__wasm_rquickjs_builtin/web_crypto:7470:53)     at test (<input>:25:27)     at <anonymous> (<input>:76:3)     at loadModule (node:module:666:24)     at...
...
- `parallel/test-webcrypto-sign-verify.js#block_00_test_sign_verify_rsassa_pkcs1_v1_5`: Unhandled promise rejection:     at generateKey (__wasm_rquickjs_builtin/web_crypto:7470:53)     at test (<input>:21:27)     at <anonymous> (<input>:34:3)     at loadModule (node:module:666:24)     at...
- `parallel/test-webcrypto-sign-verify.js#block_01_test_sign_verify_rsa_pss`: Unhandled promise rejection:     at generateKey (__wasm_rquickjs_builtin/web_crypto:7470:53)     at test (<input>:24:27)     at <anonymous> (<input>:39:3)     at loadModule (node:module:666:24)     at...
- `parallel/test-webcrypto-sign-verify.js#block_05_test_sign_verify_ed448`: Unhandled promise rejection:     at generateKey (__wasm_rquickjs_builtin/web_crypto:7470:53)     at test (<input>:33:52)     at <anonymous> (<input>:46:3)     at loadModule (node:module:666:24)     at...
...
- `parallel/test-webstreams-finished.js#block_03_block_03`: Unhandled promise rejection:     at ERR_INVALID_ARG_TYPE (__wasm_rquickjs_builtin/internal/errors:442:46)     at eos (__wasm_rquickjs_builtin/internal/streams/end-of-stream:59:19)     at <anonymous> (...
...
- `parallel/test-webstreams-finished.js#block_11_block_11`: Unhandled promise rejection:     at ERR_INVALID_ARG_TYPE (__wasm_rquickjs_builtin/internal/errors:442:46)     at eos (__wasm_rquickjs_builtin/internal/streams/end-of-stream:59:19)     at <anonymous> (...
...
- `parallel/test-webstreams-pipeline.js#block_09_block_09`: Unhandled promise rejection:     at ERR_MISSING_ARGS (__wasm_rquickjs_builtin/internal/errors:622:9)     at pipelineImpl (__wasm_rquickjs_builtin/internal/streams/pipeline:178:19)     at <anonymous> (...
...
- `parallel/test-whatwg-events-add-event-listener-options-signal.js`: The listener was still removed  1 !== 0  AssertionError: The listener was still removed  1 !== 0      at <anonymous> (<input>:127:15)     at loadModule (node:module:666:24)     at localRequire (node:m...
- `parallel/test-whatwg-events-add-event-listener-options-signal.js#block_06_block_06`: The listener was still removed  1 !== 0  AssertionError: The listener was still removed  1 !== 0      at <anonymous> (<input>:38:15)     at loadModule (node:module:666:24)     at localRequire (node:mo...
...
- `parallel/test-whatwg-events-customevent.js`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:22:3)     at loadModule (node:module:666:24)     at localRequire (node:modul...
- `parallel/test-whatwg-events-customevent.js#block_01_block_01`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:13:3)     at loadModule (node:module:666:24)     at localRequire (node:modul...
...
- `parallel/test-x509-escaping.js#block_01_test_escaping_rules_for_subject_alternative_names`: not a function     at <anonymous> (<input>:94:22)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-x509-escaping.js#block_02_test_escaping_rules_for_authority_info_access`: not a function     at <anonymous> (<input>:102:22)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-x509-escaping.js#block_03_test_escaping_rules_for_the_subject_field`: not a function     at <anonymous> (<input>:100:22)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-x509-escaping.js#block_06_the_subject_must_be_ignored_if_a_dnsname_subject_alternative`: not a function     at <anonymous> (<input>:41:24)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-x509-escaping.js#block_07_exists_even_if_other_subject_alternative_names_exist`: not a function     at <anonymous> (<input>:45:24)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `sequential/test-heapdump.js#block_00_block_00`: ENOENT: no such file or directory, chdir '/' -> '/tmp/w'     at chdir (node:process:328:112)     at <anonymous> (<input>:16:15)     at loadModule (node:module:666:24)     at localRequire (node:module:...
- `sequential/test-heapdump.js#block_01_block_01`: ENOENT: no such file or directory, chdir '/' -> '/tmp/w'     at chdir (node:process:328:112)     at <anonymous> (<input>:16:15)     at loadModule (node:module:666:24)     at localRequire (node:module:...
- `sequential/test-heapdump.js#block_02_block_02`: ENOENT: no such file or directory, chdir '/' -> '/tmp/w'     at chdir (node:process:328:112)     at <anonymous> (<input>:16:15)     at loadModule (node:module:666:24)     at localRequire (node:module:...
- `sequential/test-heapdump.js#block_03_block_03`: ENOENT: no such file or directory, chdir '/' -> '/tmp/w'     at chdir (node:process:328:112)     at <anonymous> (<input>:16:15)     at loadModule (node:module:666:24)     at localRequire (node:module:...
- `sequential/test-init.js#block_00_block_00`: ENOENT: no such file or directory, chdir '/' -> '/test/sequential'     at chdir (node:process:328:112)     at <anonymous> (<input>:48:17)     at loadModule (node:module:666:24)     at localRequire (no...
- `sequential/test-init.js#block_01_block_01`: ENOENT: no such file or directory, chdir '/' -> '/test/fixtures'     at chdir (node:process:328:112)     at <anonymous> (<input>:49:26)     at loadModule (node:module:666:24)     at localRequire (node...
- `sequential/test-init.js#block_02_block_02`: ENOENT: no such file or directory, chdir '/' -> '/test/fixtures/test-init-native'     at chdir (node:process:328:112)     at <anonymous> (<input>:53:26)     at loadModule (node:module:666:24)     at l...
- `sequential/test-single-executable-application-assets.js#block_00_block_00`: Cannot find module '../common/sea' from '/test/sequential'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous> (<input>:8:5)     at loadModule (node...
- `sequential/test-single-executable-application-assets.js#block_01_block_01`: Cannot find module '../common/sea' from '/test/sequential'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous> (<input>:8:5)     at loadModule (node...
- `sequential/test-single-executable-application-assets.js#block_02_block_02`: Cannot find module '../common/sea' from '/test/sequential'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous> (<input>:8:5)     at loadModule (node...
- `sequential/test-single-executable-application-snapshot.js#block_00_block_00`: Cannot find module '../common/sea' from '/test/sequential'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous> (<input>:8:5)     at loadModule (node...
- `sequential/test-single-executable-application-snapshot.js#block_01_block_01`: Cannot find module '../common/sea' from '/test/sequential'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous> (<input>:8:5)     at loadModule (node...

### perf_hooks

- `parallel/test-perf-hooks-histogram.js#block_00_block_00`: createHistogram is not supported in WebAssembly environment     at createHistogram (node:perf_hooks:174:15)     at <anonymous> (<input>:19:13)     at loadModule (node:module:666:24)     at localRequir...
- `parallel/test-perf-hooks-histogram.js#block_01_block_01`: monitorEventLoopDelay is not supported in WebAssembly environment     at monitorEventLoopDelay (node:perf_hooks:170:15)     at <anonymous> (<input>:21:13)     at loadModule (node:module:666:24)     at...
- `parallel/test-perf-hooks-histogram.js#block_02_block_02`: createHistogram is not supported in WebAssembly environment     at createHistogram (node:perf_hooks:174:15)     at <anonymous> (<input>:23:13)     at loadModule (node:module:666:24)     at localRequir...
- `parallel/test-perf-hooks-histogram.js#block_03_block_03`: createHistogram is not supported in WebAssembly environment     at createHistogram (node:perf_hooks:174:15)     at <anonymous> (<input>:26:13)     at loadModule (node:module:666:24)     at localRequir...
...
- `parallel/test-perf-hooks-histogram.js#block_05_block_05`: createHistogram is not supported in WebAssembly environment     at createHistogram (node:perf_hooks:174:15)     at <anonymous> (<input>:29:14)     at loadModule (node:module:666:24)     at localRequir...
- `parallel/test-perf-hooks-resourcetiming.js#block_00_performanceresourcetiming_should_not_be_initialized_external`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:15:8)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest...
- `parallel/test-perf-hooks-resourcetiming.js#block_01_using_performance_getentries`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:15:8)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest...
- `parallel/test-perf-hooks-resourcetiming.js#block_02_default_values`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:15:8)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest...
- `parallel/test-perf-hooks-resourcetiming.js#block_03_custom_getters_math`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:15:8)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest...
- `parallel/test-perf-hooks-resourcetiming.js#block_04_using_performanceobserver`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:15:8)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest...
...
- `parallel/test-performance-function.js#block_00_block_00`: not a function     at <anonymous> (<input>:18:34)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-performance-function.js#block_01_block_01`: not a function     at <anonymous> (<input>:23:25)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-performance-function.js#block_02_block_02`: not a function     at <anonymous> (<input>:22:34)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-performance-function.js#block_04_function_can_be_wrapped_many_times_also_check_length_and_nam`: not a function     at <anonymous> (<input>:27:34)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-performance-function.js#block_05_regression_tests_for_https_github_com_nodejs_node_issues_406`: not a function     at <anonymous> (<input>:70:43)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-process-env-allowed-flags.js#block_02_assert_immutability_of_process_allowednodeenvironmentflags`: Expected values to be strictly equal:  false !== true  AssertionError: Expected values to be strictly equal:  false !== true      at <anonymous> (<input>:14:38)     at loadModule (node:module:666:24) ...
...
- `parallel/test-process-getactiveresources-track-timer-lifetime.js#block_00_block_00`: not a function     at <anonymous> (<input>:8:30)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-process-getactiveresources-track-timer-lifetime.js#block_01_block_01`: not a function     at <anonymous> (<input>:10:30)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-repl-context.js#block_00_test_context_when_useglobal_is_false`: repl is not supported in WebAssembly environment     at start (node:repl:7:15)     at <anonymous> (<input>:13:18)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at...
- `parallel/test-repl-context.js#block_01_test_for_context_side_effects`: repl is not supported in WebAssembly environment     at start (node:repl:7:15)     at <anonymous> (<input>:16:23)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at...
- `parallel/test-repl-require.js#block_00_block_00`: ENOENT: no such file or directory, chdir '/' -> '/test/fixtures'     at chdir (node:process:328:112)     at <anonymous> (<input>:13:15)     at loadModule (node:module:666:24)     at localRequire (node...
- `parallel/test-repl-require.js#block_01_in_repl_we_shouldn_t_look_up_relative_modules_from_node_modu`: ENOENT: no such file or directory, chdir '/' -> '/test/fixtures'     at chdir (node:process:328:112)     at <anonymous> (<input>:13:15)     at loadModule (node:module:666:24)     at localRequire (node...
- `parallel/test-repl-tab-complete-import.js#block_00_block_00`: ENOENT: no such file or directory, chdir '/' -> '/test/fixtures'     at chdir (node:process:328:112)     at <anonymous> (<input>:19:15)     at loadModule (node:module:666:24)     at localRequire (node...
- `parallel/test-repl-tab-complete-import.js#block_01_block_01`: ENOENT: no such file or directory, chdir '/' -> '/test/fixtures'     at chdir (node:process:328:112)     at <anonymous> (<input>:19:15)     at loadModule (node:module:666:24)     at localRequire (node...
- `parallel/test-repl-tab-complete-import.js#block_02_test_tab_completion_for_import_relative_to_the_current_direc`: ENOENT: no such file or directory, chdir '/' -> '/test/fixtures'     at chdir (node:process:328:112)     at <anonymous> (<input>:19:15)     at loadModule (node:module:666:24)     at localRequire (node...
- `parallel/test-repl-tab-complete.js#block_00_block_00`: ENOENT: no such file or directory, chdir '/' -> '/test/fixtures'     at chdir (node:process:328:112)     at <anonymous> (<input>:46:15)     at loadModule (node:module:666:24)     at localRequire (node...
- `parallel/test-repl-tab-complete.js#block_01_block_01`: ENOENT: no such file or directory, chdir '/' -> '/test/fixtures'     at chdir (node:process:328:112)     at <anonymous> (<input>:46:15)     at loadModule (node:module:666:24)     at localRequire (node...
- `parallel/test-repl-tab-complete.js#block_02_test_tab_completion_for_require_relative_to_the_current_dire`: ENOENT: no such file or directory, chdir '/' -> '/test/fixtures'     at chdir (node:process:328:112)     at <anonymous> (<input>:46:15)     at loadModule (node:module:666:24)     at localRequire (node...
- `parallel/test-repl-tab-complete.js#block_03_tab_completion_for_files_directories`: ENOENT: no such file or directory, chdir '/' -> '/test/fixtures'     at chdir (node:process:328:112)     at <anonymous> (<input>:46:15)     at loadModule (node:module:666:24)     at localRequire (node...
- `parallel/test-repl-tab-complete.js#block_04_block_04`: ENOENT: no such file or directory, chdir '/' -> '/test/fixtures'     at chdir (node:process:328:112)     at <anonymous> (<input>:46:15)     at loadModule (node:module:666:24)     at localRequire (node...
...
- `parallel/test-sqlite-statement-sync.js`: Cannot mix named parameters object with positional arguments     at #processParams (node:sqlite:435:33)     at run (node:sqlite:446:44)     at <anonymous> (<input>:199:12)     at call (native)     at ...
- `parallel/test-sqlite-statement-sync.js#test_06_statementsync_prototype_expandedsql`: Cannot mix named parameters object with positional arguments     at #processParams (node:sqlite:435:33)     at run (node:sqlite:446:44)     at <anonymous> (<input>:200:12)     at call (native)     at ...
- `parallel/test-sqlite.js`: Only --eval/-e and --input-type are supported in WASM child emulation     at parseInlineEvalArgs (<input>:88:19)     at runInlineEval (<input>:122:38)     at spawnPromisified (<input>:518:50)     at <...
...
- `parallel/test-stream2-writable.js`: not a function     at <anonymous> (__wasm_rquickjs_builtin/internal/streams/readable:704:10)     at <anonymous> (<input>:301:10)     at loadModule (node:module:666:24)     at localRequire (node:module...
- `parallel/test-stream2-writable.js#block_13_block_13`: not a function     at <anonymous> (__wasm_rquickjs_builtin/internal/streams/readable:704:10)     at <anonymous> (<input>:87:10)     at loadModule (node:module:666:24)     at localRequire (node:module:...
...
- `parallel/test-streams-highwatermark.js#block_04_block_04`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:27:14)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTes...
...
- `parallel/test-runner-cli.js`: Expected values to be strictly equal:  null !== 1  AssertionError: Expected values to be strictly equal:  null !== 1      at <anonymous> (<input>:33:24)     at loadModule (node:module:666:24)     at l...
- `parallel/test-runner-cli.js#block_00_block_00`: Expected values to be strictly equal:  null !== 1  AssertionError: Expected values to be strictly equal:  null !== 1      at <anonymous> (<input>:33:24)     at loadModule (node:module:666:24)     at l...
- `parallel/test-runner-cli.js#block_01_block_01`: Expected values to be strictly equal:  null !== 1  AssertionError: Expected values to be strictly equal:  null !== 1      at <anonymous> (<input>:33:24)     at loadModule (node:module:666:24)     at l...
- `parallel/test-runner-cli.js#block_02_block_02`: Expected values to be strictly equal:  null !== 1  AssertionError: Expected values to be strictly equal:  null !== 1      at <anonymous> (<input>:33:24)     at loadModule (node:module:666:24)     at l...
- `parallel/test-runner-cli.js#block_03_block_03`: Expected values to be strictly equal:  null !== 1  AssertionError: Expected values to be strictly equal:  null !== 1      at <anonymous> (<input>:33:24)     at loadModule (node:module:666:24)     at l...
- `parallel/test-runner-cli.js#block_04_block_04`: Expected values to be strictly equal:  null !== 1  AssertionError: Expected values to be strictly equal:  null !== 1      at <anonymous> (<input>:33:24)     at loadModule (node:module:666:24)     at l...
- `parallel/test-runner-cli.js#block_05_block_05`: Expected values to be strictly equal:  null !== 1  AssertionError: Expected values to be strictly equal:  null !== 1      at <anonymous> (<input>:33:24)     at loadModule (node:module:666:24)     at l...
- `parallel/test-runner-cli.js#block_06_block_06`: Expected values to be strictly equal:  null !== 1  AssertionError: Expected values to be strictly equal:  null !== 1      at <anonymous> (<input>:33:24)     at loadModule (node:module:666:24)     at l...
- `parallel/test-runner-cli.js#block_07_block_07`: Expected values to be strictly equal:  null !== 1  AssertionError: Expected values to be strictly equal:  null !== 1      at <anonymous> (<input>:33:24)     at loadModule (node:module:666:24)     at l...
- `parallel/test-runner-cli.js#block_08_block_08`: Expected values to be strictly equal:  null !== 1  AssertionError: Expected values to be strictly equal:  null !== 1      at <anonymous> (<input>:33:24)     at loadModule (node:module:666:24)     at l...
- `parallel/test-runner-cli.js#block_09_block_09`: Expected values to be strictly equal:  null !== 1  AssertionError: Expected values to be strictly equal:  null !== 1      at <anonymous> (<input>:33:24)     at loadModule (node:module:666:24)     at l...
- `parallel/test-runner-cli.js#block_10_block_10`: Expected values to be strictly equal:  null !== 1  AssertionError: Expected values to be strictly equal:  null !== 1      at <anonymous> (<input>:33:24)     at loadModule (node:module:666:24)     at l...
...
- `parallel/test-tls-external-accessor.js#block_01_block_01`: not a function     at <anonymous> (<input>:13:20)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-tls-translate-peer-certificate.js#block_00_block_00`: Cannot find module '_tls_common'     at localRequire (node:module:773:59)     at <anonymous> (<input>:9:38)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTe...
- `parallel/test-tls-translate-peer-certificate.js#block_01_block_01`: Cannot find module '_tls_common'     at localRequire (node:module:773:59)     at <anonymous> (<input>:9:38)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTe...
...
- `parallel/test-v8-collect-gc-profile-exit-before-stop.js#block_00_test_if_it_makes_the_process_crash`: not a function     at <anonymous> (<input>:7:24)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-v8-collect-gc-profile-exit-before-stop.js#block_01_block_01`: not a function     at <anonymous> (<input>:8:24)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-v8-query-objects.js#block_01_block_01`: not a function     at <anonymous> (<input>:24:38)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-v8-query-objects.js#block_02_block_02`: not a function     at <anonymous> (<input>:27:35)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-v8-query-objects.js#block_03_block_03`: not a function     at <anonymous> (<input>:27:38)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-v8-query-objects.js#block_04_block_04`: not a function     at <anonymous> (<input>:35:35)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-vm-context-dont-contextify.js#block_00_block_00`: cannot read property 'DONT_CONTEXTIFY' of undefined     at <anonymous> (<input>:13:36)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runne...
- `parallel/test-vm-context-dont-contextify.js#block_01_block_01`: cannot read property 'DONT_CONTEXTIFY' of undefined     at <anonymous> (<input>:15:36)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runne...
- `parallel/test-vm-context-dont-contextify.js#block_02_block_02`: cannot read property 'DONT_CONTEXTIFY' of undefined     at <anonymous> (<input>:17:36)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runne...
- `parallel/test-vm-context-dont-contextify.js#block_03_block_03`: cannot read property 'DONT_CONTEXTIFY' of undefined     at <anonymous> (<input>:21:24)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runne...
- `parallel/test-vm-context-dont-contextify.js#block_04_block_04`: cannot read property 'DONT_CONTEXTIFY' of undefined     at <anonymous> (<input>:22:5)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner...
- `parallel/test-vm-context-dont-contextify.js#block_05_block_05`: cannot read property 'DONT_CONTEXTIFY' of undefined     at <anonymous> (<input>:23:36)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runne...
- `parallel/test-vm-context-dont-contextify.js#block_06_block_06`: cannot read property 'DONT_CONTEXTIFY' of undefined     at <anonymous> (<input>:76:36)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runne...
- `parallel/test-vm-context-dont-contextify.js#block_07_block_07`: cannot read property 'DONT_CONTEXTIFY' of undefined     at <anonymous> (<input>:78:36)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runne...
- `parallel/test-vm-measure-memory-lazy.js#block_00_or_otherwise_these_may_not_resolve`: Cannot find module '../common/measure-memory' from '/test/parallel'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous> (<input>:8:5)     at loadMod...
- `parallel/test-vm-measure-memory-lazy.js#block_01_block_01`: Cannot find module '../common/measure-memory' from '/test/parallel'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous> (<input>:8:5)     at loadMod...
- `parallel/test-vm-measure-memory-lazy.js#block_02_block_02`: Cannot find module '../common/measure-memory' from '/test/parallel'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous> (<input>:8:5)     at loadMod...
- `parallel/test-vm-measure-memory-lazy.js#block_03_block_03`: Cannot find module '../common/measure-memory' from '/test/parallel'     at resolveFilename (node:module:359:80)     at localRequire (node:module:761:44)     at <anonymous> (<input>:8:5)     at loadMod...
- `parallel/test-vm-new-script-new-context.js`: Expected values to be strictly equal:  0 !== 1  AssertionError: Expected values to be strictly equal:  0 !== 1      at <anonymous> (<input>:71:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-vm-new-script-new-context.js#block_04_block_04`: Expected values to be strictly equal:  0 !== 1  AssertionError: Expected values to be strictly equal:  0 !== 1      at <anonymous> (<input>:47:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-vm-new-script-new-context.js#block_07_block_07`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:45:10)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTes...

### worker_threads

- `parallel/test-worker-broadcastchannel-wpt.js#block_00_block_00`: worker_threads is not supported in WebAssembly environment     at BroadcastChannel (node:worker_threads:234:19)     at <anonymous> (<input>:10:18)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-worker-broadcastchannel-wpt.js#block_01_block_01`: worker_threads is not supported in WebAssembly environment     at BroadcastChannel (node:worker_threads:234:19)     at <anonymous> (<input>:35:18)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-worker-broadcastchannel-wpt.js#block_02_block_02`: worker_threads is not supported in WebAssembly environment     at BroadcastChannel (node:worker_threads:234:19)     at <anonymous> (<input>:15:18)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-worker-broadcastchannel-wpt.js#block_03_block_03`: worker_threads is not supported in WebAssembly environment     at BroadcastChannel (node:worker_threads:234:19)     at <anonymous> (<input>:17:18)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-worker-broadcastchannel-wpt.js#block_04_block_04`: worker_threads is not supported in WebAssembly environment     at BroadcastChannel (node:worker_threads:234:19)     at <anonymous> (<input>:19:18)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-worker-broadcastchannel-wpt.js#block_05_block_05`: worker_threads is not supported in WebAssembly environment     at BroadcastChannel (node:worker_threads:234:19)     at <anonymous> (<input>:24:20)     at loadModule (node:module:666:24)     at localRe...
...
- `parallel/test-worker-execargv-invalid.js#block_00_block_00`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:13:10)     at loadModule (node:module:666:24)     at localRequire (node:modu...
- `parallel/test-worker-execargv-invalid.js#block_01_block_01`: Missing expected exception (Error). AssertionError: Missing expected exception (Error).     at <anonymous> (<input>:14:10)     at loadModule (node:module:666:24)     at localRequire (node:module:762:3...
- `parallel/test-worker-execargv-invalid.js#block_02_block_02`: Missing expected exception (Error). AssertionError: Missing expected exception (Error).     at <anonymous> (<input>:16:10)     at loadModule (node:module:666:24)     at localRequire (node:module:762:3...
- `parallel/test-worker-message-event.js#block_00_block_00`: MessageEvent is not defined     at <anonymous> (<input>:52:20)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-worker-message-event.js#block_02_block_02`: MessageEvent is not defined     at <anonymous> (<input>:12:14)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-worker-message-mark-as-uncloneable.js#block_00_uncloneables_cannot_be_cloned_during_message_posting`: not a function     at <anonymous> (<input>:13:21)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-worker-message-mark-as-uncloneable.js#block_01_uncloneables_cannot_be_cloned_during_structured_cloning`: not a function     at <anonymous> (<input>:23:21)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-worker-message-mark-as-uncloneable.js#block_02_markasuncloneable_cannot_affect_arraybuffer`: not a function     at <anonymous> (<input>:20:21)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-worker-message-mark-as-uncloneable.js#block_03_markasuncloneable_can_affect_node_js_built_in_object_like_bl`: not a function     at <anonymous> (<input>:30:21)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-worker-message-port-close.js#block_00_block_00`: not a function     at <anonymous> (<input>:21:9)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-worker-message-port-close.js#block_02_block_02`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:19:10)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTes...
...
- `parallel/test-worker-message-port-wasm-threads.js#block_00_block_00`: WebAssembly is not defined     at <anonymous> (<input>:11:24)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-worker-message-port-wasm-threads.js#block_01_block_01`: WebAssembly is not defined     at <anonymous> (<input>:11:24)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-worker-message-port.js`: not a function     at <anonymous> (<input>:22:40)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-worker-message-port.js#block_01_block_01`: not a function     at <anonymous> (<input>:11:40)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-worker-message-port.js#block_04_block_04`: not a function     at <anonymous> (<input>:22:9)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
...
- `parallel/test-worker-message-port.js#block_06_block_06`: Expected values to be strictly equal:  10 !== 0  AssertionError: Expected values to be strictly equal:  10 !== 0      at <anonymous> (<input>:40:24)     at loadModule (node:module:666:24)     at local...
...
- `parallel/test-worker-message-transfer-port-mark-as-untransferable.js#block_00_block_00`: not a function     at <anonymous> (<input>:10:38)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-worker-message-transfer-port-mark-as-untransferable.js#block_01_block_01`: not a function     at <anonymous> (<input>:13:38)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-worker-message-transfer-port-mark-as-untransferable.js#block_02_block_02`: not a function     at <anonymous> (<input>:13:41)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-worker-message-transfer-port-mark-as-untransferable.js#block_03_block_03`: not a function     at <anonymous> (<input>:16:38)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest (node-compat-runner:146:25)
- `parallel/test-worker-unsupported-path.js#block_00_block_00`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:14:10)     at loadModule (node:module:666:24)     at localRequire (node:modu...
- `parallel/test-worker-unsupported-path.js#block_01_block_01`: Missing expected exception. AssertionError: Missing expected exception.     at <anonymous> (<input>:12:5)     at loadModule (node:module:666:24)     at localRequire (node:module:762:34)     at runTest...
- `parallel/test-worker-unsupported-path.js#block_02_block_02`: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError).     at <anonymous> (<input>:17:10)     at loadModule (node:module:666:24)     at localRequire (node:modu...
- `parallel/test-worker-workerdata-messageport.js`: Expected values to be strictly equal:  4 !== 0  AssertionError: Expected values to be strictly equal:  4 !== 0      at <anonymous> (<input>:44:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-worker-workerdata-messageport.js#block_02_block_02`: Expected values to be strictly equal:  4 !== 0  AssertionError: Expected values to be strictly equal:  4 !== 0      at <anonymous> (<input>:34:22)     at loadModule (node:module:666:24)     at localRe...
- `parallel/test-worker-workerdata-messageport.js#block_03_block_03`: Missing expected exception (DataCloneError). AssertionError: Missing expected exception (DataCloneError).     at <anonymous> (<input>:35:14)     at loadModule (node:module:666:24)     at localRequire ...
...
- `parallel/test-abortcontroller.js`: error while executing at wasm backtrace:     0: 0xebf0b1 - node_compat_runner.wasm!abort     1: 0xec0a3d - node_compat_runner.wasm!__assert_fail     2: 0xd59b14 - node_compat_runner.wasm!gc_scan     3...
...
- `parallel/test-whatwg-events-add-event-listener-options-signal.js#block_08_block_08`: error while executing at wasm backtrace:     0: 0xd82f19 - node_compat_runner.wasm!JS_CallInternal     1: 0xd86ace - node_compat_runner.wasm!JS_CallInternal     2: 0xd864fd - node_compat_runner.wasm!J...
- `parallel/test-worker-eval-typescript.js#test_00_worker_eval_module_typescript_without_input_type`: error while executing at wasm backtrace:     0: 0xebf0b1 - node_compat_runner.wasm!abort     1: 0xeb5c5c - node_compat_runner.wasm!std::sys::pal::wasi::helpers::abort_internal::h55c751025c93bbd8     2...
- `parallel/test-worker-eval-typescript.js#test_01_worker_eval_module_typescript_with_input_type_module_typescr`: error while executing at wasm backtrace:     0: 0xebf0b1 - node_compat_runner.wasm!abort     1: 0xeb5c5c - node_compat_runner.wasm!std::sys::pal::wasi::helpers::abort_internal::h55c751025c93bbd8     2...
- `parallel/test-worker-eval-typescript.js#test_02_worker_eval_module_typescript_with_input_type_commonjs_types`: error while executing at wasm backtrace:     0: 0xebf0b1 - node_compat_runner.wasm!abort     1: 0xeb5c5c - node_compat_runner.wasm!std::sys::pal::wasi::helpers::abort_internal::h55c751025c93bbd8     2...
- `parallel/test-worker-eval-typescript.js#test_03_worker_eval_module_typescript_with_input_type_module`: error while executing at wasm backtrace:     0: 0xebf0b1 - node_compat_runner.wasm!abort     1: 0xeb5c5c - node_compat_runner.wasm!std::sys::pal::wasi::helpers::abort_internal::h55c751025c93bbd8     2...
- `parallel/test-worker-eval-typescript.js#test_04_worker_eval_commonjs_typescript_without_input_type`: error while executing at wasm backtrace:     0: 0xebf0b1 - node_compat_runner.wasm!abort     1: 0xeb5c5c - node_compat_runner.wasm!std::sys::pal::wasi::helpers::abort_internal::h55c751025c93bbd8     2...
- `parallel/test-worker-eval-typescript.js#test_05_worker_eval_commonjs_typescript_with_input_type_commonjs_typ`: error while executing at wasm backtrace:     0: 0xebf0b1 - node_compat_runner.wasm!abort     1: 0xeb5c5c - node_compat_runner.wasm!std::sys::pal::wasi::helpers::abort_internal::h55c751025c93bbd8     2...
- `parallel/test-worker-eval-typescript.js#test_06_worker_eval_commonjs_typescript_with_input_type_module_types`: error while executing at wasm backtrace:     0: 0xebf0b1 - node_compat_runner.wasm!abort     1: 0xeb5c5c - node_compat_runner.wasm!std::sys::pal::wasi::helpers::abort_internal::h55c751025c93bbd8     2...
...
| test-http-insecure-parser-per-stream.js | 5 | 5 | 0 | 0 | 0 |
...
34 test(s) should be unskipped:

- `parallel/test-http-autoselectfamily.js`
- `parallel/test-http-client-req-error-dont-double-fire.js`
- `parallel/test-http-client-timeout-option-with-agent.js`
- `parallel/test-http-max-header-size-per-stream.js`
- `parallel/test-http-outgoing-buffer.js`
...
- `parallel/test-http-max-header-size-per-stream.js#block_02_test_3_the_client_sends_larger_headers_than_what_would_other`
- `parallel/test-http-max-header-size-per-stream.js#block_03_test_4_the_same_as_test_3_except_without_the_option_to_make_`
- `parallel/test-http-outgoing-internal-headers.js#block_00_block_00`
- `parallel/test-http-outgoing-internal-headers.js#block_01_block_01`
- `parallel/test-http-outgoing-internal-headers.js#block_02_block_02`
- `parallel/test-http-outgoing-renderHeaders.js#block_00_block_00`
- `parallel/test-http-outgoing-renderHeaders.js#block_01_block_01`
- `parallel/test-http-outgoing-renderHeaders.js#block_02_block_02`
- `parallel/test-http-outgoing-renderHeaders.js#block_03_block_03`
- `parallel/test-https-insecure-parse-per-stream.js#block_00_test_1_the_server_sends_an_invalid_header`
- `parallel/test-https-insecure-parse-per-stream.js#block_01_test_2_the_same_as_test_1_except_without_the_option_to_make_`
- `parallel/test-https-insecure-parse-per-stream.js#block_04_test_5_invalid_argument_type`
- `parallel/test-https-max-header-size-per-stream.js#block_00_test_1_the_server_sends_larger_headers_than_what_would_other`
